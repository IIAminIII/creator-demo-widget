...
function normalizeCreatorRecord(record) {
  return {
    ...
    customerName: getFirstString(record.Books_Customer_Name, record.Customer_Name),
    invoiceTotal: toNumber(record.Invoice_Total),
    currencyCode: getFirstString(record.Currency_Code, "USD"),
    dueDate: getFirstString(record.Due_Date),
    invoiceDate: getFirstString(record.Invoice_Date),
    booksStatus: getFirstString(record.Books_Invoice_Status, "sent"),
